...
local swwwRandom = uscripts .. "/WallpaperAutoChange.sh"
...
hl.bind(mainMod .. " + CTRL + G", hl.dsp.exec_cmd("hyprctl dispatch moveoutofgroup"))
hl.bind("CTRL + SHIFT + 1", hl.dsp.exec_cmd("hyprctl dispatch changegroupactive 1"))
hl.bind("CTRL + SHIFT + 2", hl.dsp.exec_cmd("hyprctl dispatch changegroupactive 2"))
hl.bind("CTRL + SHIFT + 3", hl.dsp.exec_cmd("hyprctl dispatch changegroupactive 3"))
hl.bind("CTRL + SHIFT + 4", hl.dsp.exec_cmd("hyprctl dispatch changegroupactive 4"))
hl.bind("CTRL + SHIFT + 5", hl.dsp.exec_cmd("hyprctl dispatch changegroupactive 5"))
hl.bind("CTRL + SHIFT + 6", hl.dsp.exec_cmd("hyprctl dispatch changegroupactive 6"))
hl.bind("CTRL + SHIFT + 7", hl.dsp.exec_cmd("hyprctl dispatch changegroupactive 7"))
hl.bind("CTRL + SHIFT + 8", hl.dsp.exec_cmd("hyprctl dispatch changegroupactive 8"))
hl.bind("CTRL + SHIFT + 9", hl.dsp.exec_cmd("hyprctl dispatch changegroupactive 9"))

-- Workspace switching
hl.bind(mainMod .. " + Tab", hl.dsp.focus({ workspace = "m+1" }))
hl.bind(mainMod .. " + SHIFT + Tab", hl.dsp.focus({ workspace = "m-1" }))
hl.bind(mainMod .. " + CTRL + U", hl.dsp.exec_cmd("hyprctl dispatch movetoworkspace special"))
...
-- Workspace switching with keys 0-9
for i = 1, 10 do
    local key = i % 10
...
-- User keybinds from UserKeybinds.conf
...
-- Brightness with mouse wheel (override default workspace switching)
...
-- Thumb wheel workspace switching
...
-- Mouse thumb buttons for focus
hl.bind(mainMod .. " + mouse:275", hl.dsp.exec_cmd("hyprctl dispatch focuswindow class:obsidian"))
hl.bind(mainMod .. " + mouse:276", hl.dsp.exec_cmd("hyprctl dispatch focuswindow class:jetbrains-clion"))
...
-- Silent workspace moves for workspaces 1-5 (already handled in loop above for 1-10, but these override)
hl.bind(mainMod .. " + SHIFT + CTRL + 1", hl.dsp.exec_cmd("hyprctl dispatch movetoworkspacesilent 1"))
hl.bind(mainMod .. " + SHIFT + CTRL + 2", hl.dsp.exec_cmd("hyprctl dispatch movetoworkspacesilent 2"))
hl.bind(mainMod .. " + SHIFT + CTRL + 3", hl.dsp.exec_cmd("hyprctl dispatch movetoworkspacesilent 3"))
hl.bind(mainMod .. " + SHIFT + CTRL + 4", hl.dsp.exec_cmd("hyprctl dispatch movetoworkspacesilent 4"))
hl.bind(mainMod .. " + SHIFT + CTRL + 5", hl.dsp.exec_cmd("hyprctl dispatch movetoworkspacesilent 5"))
hl.bind(mainMod .. " + SHIFT + CTRL + 6", hl.dsp.exec_cmd("hyprctl dispatch movetoworkspacesilent 6"))
hl.bind(mainMod .. " + SHIFT + CTRL + 7", hl.dsp.exec_cmd("hyprctl dispatch movetoworkspacesilent 7"))
hl.bind(mainMod .. " + SHIFT + CTRL + 8", hl.dsp.exec_cmd("hyprctl dispatch movetoworkspacesilent 8"))
hl.bind(mainMod .. " + SHIFT + CTRL + 9", hl.dsp.exec_cmd("hyprctl dispatch movetoworkspacesilent 9"))

-- Screenshots with F6 (laptop)
...
-- User dashboard apps on workspace 4
